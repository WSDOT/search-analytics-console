## WSDOT Search Analytics Console
...
* Searches per day and hour. Click a bar to see what users searched for and from where on your site.

### Set Up

This project requires you to [set up Site Search analytics with Google Anayltics](https://support.google.com/analytics/answer/1012264?hl=en).

Once you've cloned the repo you will need to create a file named `.env` in the root directory. This file holds variables used during the build process.
This file must include the following 3 items:

* REACT_APP_HOME - url path for analytics console. (ex. /projects/analytics-console/)
...
When you're ready to deploy, just run `npm run build`. This builds the app for production to the `build` folder.

### This project is built with React and Redux using the Create React App project. 
* [Learn about React](https://facebook.github.io/react/)
* [Learn about Redux](http://redux.js.org/)
* [Learn about Flux Architecture](https://facebook.github.io/flux/)
* [Create React App](https://github.com/facebookincubator/create-react-app)

- - -

## :large_blue_diamond: Below is the Create React App README :large_blue_diamond:
...
my-app/
  ...
  public/
    ...
    favicon.ico
  src/
    index.js // Kicks off the app by rendering Root component in the DOM.
    Root.js // Wraps the main app with the Provider component.
    SearchAdminConsole.js // Main component, renders navigation components and handles react-router logic.
    configureStore.js // Sets up the Redux Store.
    global-components/ // Holds components used through out the app.
    Main Feature Directories // Directory for top-level components in the main nav (analytics & searchConfig).
